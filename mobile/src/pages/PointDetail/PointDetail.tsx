...
const PointDetail = () => {
  ...
  const pointId = (route.params as Params).pointId
  ...
  function handleWhatsapp() {
    if (point) {
      Linking.openURL(`whatsapp://send?phone=+55${point.whatsapp}&text=I have interest in waste collection`)
    }
  }
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <View style={styles.address}>
          ...
          <Text style={styles.addressContent}>{point.city}, {point.state}</Text>
        </View>
      </View>
